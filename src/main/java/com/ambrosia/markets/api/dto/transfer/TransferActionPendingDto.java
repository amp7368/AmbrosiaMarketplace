...
public class TransferActionPendingDto {
    ...
    public final boolean isBuyerConfirmed;
    public final boolean isSellerConfirmed;

    public TransferActionPendingDto(DTransferActionPending transfer) {
        ...
        this.isSellerConfirmed = transfer.isSellerConfirmed();
        this.isBuyerConfirmed = transfer.isBuyerConfirmed();
    }
}
